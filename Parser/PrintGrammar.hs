...
instance Print (Program a) where
  prt i e = case e of
    Program _ decls -> prPrec i 0 (concatD [prt 0 decls])

instance Print (Block a) where
  prt i e = case e of
    Block _ blockinsts -> prPrec i 0 (concatD [doc (showString "{"), prt 0 blockinsts, doc (showString "}")])

instance Print (BlockInst a) where
  prt i e = case e of
    DeclInst _ decl -> prPrec i 0 (concatD [prt 0 decl])
    StmtInst _ stmt -> prPrec i 0 (concatD [prt 0 stmt])
  prtList _ [] = (concatD [])
  prtList _ (x:xs) = (concatD [prt 0 x, prt 0 xs])
instance Print (Decl a) where
  prt i e = case e of
    FnDecl _ type_ id args block -> prPrec i 0 (concatD [prt 0 type_, prt 0 id, doc (showString "("), prt 0 args, doc (showString ")"), prt 0 block])
    VarDecl _ type_ items -> prPrec i 0 (concatD [prt 0 type_, prt 0 items, doc (showString ";")])
  prtList _ [] = (concatD [])
  prtList _ (x:xs) = (concatD [prt 0 x, prt 0 xs])
...
instance Print (Type a) where
  prt i e = case e of
    ...
    Fun _ type_ argtypes -> prPrec i 0 (concatD [prt 0 type_, doc (showString "("), prt 0 argtypes, doc (showString ")")])

instance Print (ArgType a) where
  prt i e = case e of
    ValArgType _ type_ -> prPrec i 0 (concatD [prt 0 type_])
